...
public class BitherTrustManager implements X509TrustManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(BitherTrustManager.class);
    ...
    public void checkClientTrusted(X509Certificate[] chain, String authType) throws
        ...
        try {
            log.debug("checkServerTrusted() with default trust manager...");
            defaultTrustManager.checkClientTrusted(chain, authType);
        } catch (CertificateException ce) {
            log.debug("checkServerTrusted() with bither trust manager...");
