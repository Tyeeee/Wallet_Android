...
/**
 * <p>A generic interface for an object which keeps track of a set of open client connections,
 * creates new ones and
 * ensures they are serviced properly.</p>
 * <p/>
 * <p>When the service is {@link Service#stop()}ed,
 * all connections will be closed and
 * the appropriate connectionClosed() calls must be made.</p>
 */
public interface ClientConnectionManager extends Service {
    /**
     * Creates a new connection to the given address, with the given parser used to handle
     * incoming data.
     */
