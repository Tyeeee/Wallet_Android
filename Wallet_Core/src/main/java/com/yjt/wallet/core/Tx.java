...
import com.yjt.wallet.core.script.ScriptOpCodes;
...
//    public int length;
    ...
    public byte[] getTxHash() {
        if (txHash == null) {
            ...
            txHash = Utils.doubleDigest(bits);
        }
        return txHash;
    }
    ...
    public void recalculateTxHash() {
        byte[] bits = bitcoinSerialize();
        this.txHash = Utils.doubleDigest(bits);
     ...
     *
     * @param hashType
     *         This should always be set to SigHash.ALL currently. Other types are unused.
     * @param address
...
//            cannot be statically proven
     ...
     * @param aesKey
     *         If not null, this will be used to decrypt the key.
     * @param connectedPubKeyScript
     ...
     *         The private key used to calculate the signature.
     * @param connectedPubKeyScript
     *         The scriptPubKey that is being satisified.
     * @param hashType
     *         Signing mode, see the enum for documentation.
     * @param anyoneCanPay
     *         Signing mode, see the SigHash enum for documentation.
    ...
    protected void bitcoinSerializeToStream(OutputStream stream) throws IOException {
        ...
        Utils.uint32ToByteStreamLE(txLockTime, stream);
    }
