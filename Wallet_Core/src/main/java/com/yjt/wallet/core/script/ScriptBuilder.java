 ...
 * convenience methods on {@link net.bither.bitherj.core.Tx}, but they are useful when working with the
...
public class ScriptBuilder {
    ...
    public static Script createOutputScript(String to) {
        if (Utils.getAddressHeader(to) == BitherjSettings.p2shHeader) {
            ...
            // ScriptOpCodes.OP_DUP ScriptOpCodes.OP_HASH160 <pubKeyHash> ScriptOpCodes.OP_EQUALVERIFY ScriptOpCodes.OP_CHECKSIG
            return new ScriptBuilder()
    ...
    /**
     * Create a program that satisfies an ScriptOpCodes.OP_CHECKMULTISIG program.
     */
    ...
    /**
     * Create a program that satisfies an ScriptOpCodes.OP_CHECKMULTISIG program, using pre-encoded signatures.
     */
    ...
    /**
     * Create a program that satisfies a pay-to-script hashed ScriptOpCodes.OP_CHECKMULTISIG program.
     */
