...
public class TabStrip extends LinearLayout {
    ...
    TabStrip(Context context, AttributeSet attrs) {
        ...
        int dividerColorsId = View.NO_ID;
        ...
        indicatorAlwaysInCenter = a.getBoolean(R.styleable.TabLayout_tl_indicatorAlwaysInCenter, indicatorAlwaysInCenter);
        indicatorWithoutPadding = a.getBoolean(R.styleable.TabLayout_tl_indicatorWithoutPadding, indicatorWithoutPadding);
        indicatorInFront = a.getBoolean(R.styleable.TabLayout_tl_indicatorInFront, indicatorInFront);
        indicationInterpolatorId = a.getInt(R.styleable.TabLayout_tl_indicatorInterpolation, indicationInterpolatorId);
        indicatorGravity = a.getInt(R.styleable.TabLayout_tl_indicatorGravity, indicatorGravity);
        indicatorColor = a.getColor(R.styleable.TabLayout_tl_indicatorColor, indicatorColor);
        indicatorColorsId = a.getResourceId(R.styleable.TabLayout_tl_indicatorColors, indicatorColorsId);
        indicatorThickness = a.getDimensionPixelSize(R.styleable.TabLayout_tl_indicatorThickness, indicatorThickness);
        indicatorWidth = a.getLayoutDimension(R.styleable.TabLayout_tl_indicatorWidth, indicatorWidth);
        indicatorCornerRadius = a.getDimension(R.styleable.TabLayout_tl_indicatorCornerRadius, indicatorCornerRadius);
        overlineColor = a.getColor(R.styleable.TabLayout_tl_overlineColor, overlineColor);
        overlineThickness = a.getDimensionPixelSize(R.styleable.TabLayout_tl_overlineThickness, overlineThickness);
        underlineColor = a.getColor(R.styleable.TabLayout_tl_underlineColor, underlineColor);
        underlineThickness = a.getDimensionPixelSize(R.styleable.TabLayout_tl_underlineThickness, underlineThickness);
        dividerColor = a.getColor(R.styleable.TabLayout_tl_dividerColor, dividerColor);
        dividerColorsId = a.getResourceId(R.styleable.TabLayout_tl_dividerColors, dividerColorsId);
        dividerThickness = a.getDimensionPixelSize(R.styleable.TabLayout_tl_dividerThickness, dividerThickness);
        drawDecorationAfterTab = a.getBoolean(R.styleable.TabLayout_tl_drawDecorationAfterTab, drawDecorationAfterTab);
        a.recycle();
        ...
        this.indicationInterpolator = TabIndicationInterpolator.of(indicationInterpolatorId);
    }
    ...
    void setIndicationInterpolator(TabIndicationInterpolator interpolator) {
    ...
    private void drawDecoration(Canvas canvas) {
        ...
        if (tabCount > 0) {
            ...
            int selectedStart = ViewUtil.getInstance().getStart(selectedTab, indicatorWithoutPadding);
            int selectedEnd = ViewUtil.getInstance().getEnd(selectedTab, indicatorWithoutPadding);
            int left;
            int right;
            if (isLayoutRtl) {
                left = selectedEnd;
            ...
            if (selectionOffset > 0f && selectedPosition < (getChildCount() - 1)) {
                ...
                int nextStart = ViewUtil.getInstance().getStart(nextTab, indicatorWithoutPadding);
                int nextEnd = ViewUtil.getInstance().getEnd(nextTab, indicatorWithoutPadding);
                if (isLayoutRtl) {
    ...
    private void drawSeparator(Canvas canvas, int height, int tabCount) {
        ...
        for (int i = 0; i < tabCount - 1; i++) {
            ...
            int end = ViewUtil.getInstance().getEnd(child);
            int endMargin = ViewUtil.getInstance().getMarginEnd(child);
