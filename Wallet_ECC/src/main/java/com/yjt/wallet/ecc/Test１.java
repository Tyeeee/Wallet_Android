...
//            if (ecParameterSpec != null && generator != null) {
...
//            }
//        } catch (NoSuchAlgorithmException | InvalidAlgorithmParameterException | NoSuchProviderException | InvalidKeySpecException | BadPaddingException | IllegalBlockSizeException | NoSuchPaddingException | InvalidParameterSpecException | InvalidKeyException | IOException | CertificateException | OperatorCreationException e) {
//            e.printStackTrace();
//        }
//    }
//
...
//        } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidAlgorithmParameterException | InvalidKeyException | InvalidKeySpecException e) {
//            e.printStackTrace();
//        }
//        return null;
//    }
...
//    }
//
//    private static byte[] generatePKCS10CSRAndSign(PublicKey publicKey, PrivateKey privateKey) throws OperatorCreationException, IOException, CertificateException, InvalidKeyException, NoSuchAlgorithmException {
//        // CSR  
